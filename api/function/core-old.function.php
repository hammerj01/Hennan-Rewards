<?php
	...
	switch ($_GET['function']) {
		...
		case 'social_login':
			$default = array("email" => NULL, "pid" => NULL, "platform" => NULL, "deviceID" => NULL, "fname" => NULL, "mname" => NULL, "lname" => NULL, "dateOfBirth" => NULL, "gender" => NULL, "image" => NULL, "emailFromFB" => NULL, "regtype" => NULL, "memberCode" => NULL, "locID" => NULL, "brandID"=> NULL, "mobileNum" => NULL, "qrCard" => NULL,"password"=>NULL, "pinCode" => NULL,"serverName" => NULL, "emailFromFB" => NULL);
		...
		case 'request_card':
			$default = array("id" => NULL, "email" => NULL, "password" => NULL, "mname" => NULL, "landlineNum" => NULL, "memberID" => NULL,"platform" => NULL,"fname" => NULL,"lname" => NULL, "house_no" => NULL,"street_no"=>NULL,"barangay"=>NULL,"city"=>NULL,"mobileNum"=>NULL,"telNum"=>NULL);
			$required =array("platform","fname","lname","house_no","street_no","barangay","city","mobileNum","memberID");
			$data = process_params($default, $required, $params);
